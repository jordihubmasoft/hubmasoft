...
// Columnas de la tabla de facturas de compras
const allColumns = [
  ...
  { id: 'estado', label: 'Estado' },  // Nueva columna para 'Estado'
];

// Datos de ejemplo para la tabla de facturas de compras
const ordersData = [];
    ...
    <Container maxWidth="lg" sx={{ mt: 4 }}>
      ...
      <Box display="flex" alignItems="center" mb={3}>
        ...
        <Typography variant="h5" component="div" sx={{ flexGrow: 1, fontWeight: 'bold' }}>
          {order ? 'Editar Factura' : 'Nueva Factura de Compra'}
        </Typography>
      </Box>
  ...
  const renderEstadoCell = (estado) => {
    ...
    return (
      <TableCell sx={{ bgcolor: color, color: '#fff', fontWeight: 'bold' }}>
        {estado === 'pendiente' ? 'Pendiente' : estado === 'vencido' ? 'Vencido' : 'Pagado'}
      </TableCell>
    );
  };
