...
// Datos de ejemplo de facturas recurrentes de compras
const recurringInvoicesData = [
  { id: 1, proveedor: 'Proveedor 1', intervalo: '1 mes', fechaInicio: '2023-09-01', fechaFin: '2024-09-01' },
  { id: 2, proveedor: 'Proveedor 2', intervalo: '3 meses', fechaInicio: '2023-01-01', fechaFin: '2024-01-01' },
];

const initialEmails = [
  'compras@empresa.com',
  'proveedores@empresa.com',
  'admin@empresa.com',
  ...
  return (
    <Container maxWidth="xl" sx={{ mt: 4 }}>
      ...
      <Paper elevation={3} sx={{ p: 4, mb: 4, borderRadius: 2 }}>
        {/* Campos del formulario para la factura recurrente */}
          ...
          <Table>
            ...
            <TableBody>
              ...
              <TableRow>
                ...
                <TableCell>Descripción del producto A</TableCell>
                <TableCell>10</TableCell>
                <TableCell>100,00€</TableCell>
                <TableCell>21%</TableCell>
                <TableCell>1210,00€</TableCell>
              </TableRow>
            </TableBody>
          </Table>
        </TableContainer>
...
const FacturasRecurrentesCompras = () => {
            ...
            >
              <Container maxWidth="lg">
                <Typography variant="h3" gutterBottom sx={{ color: '#1A1A40', fontWeight: '600' }}>
                  Facturas Recurrentes de Compras
                </Typography>
...
export default FacturasRecurrentesCompras;
