...
// Columnas de la tabla de albaranes de compras
const allColumns = [
  { id: 'numero', label: 'Número' },
  { id: 'fecha', label: 'Fecha' },
  { id: 'recogida', label: 'Recogida' },
  { id: 'proveedor', label: 'Proveedor' }, // Cambiado de contacto a proveedor
...
// Datos de ejemplo para la tabla de albaranes de compras
const ordersData = [];
    ...
    <Container maxWidth="lg" sx={{ mt: 4 }}>
      ...
      <Box display="flex" alignItems="center" mb={3}>
        ...
        <Typography variant="h5" component="div" sx={{ flexGrow: 1, fontWeight: 'bold' }}>
          {order ? 'Editar Albarán' : 'Nuevo Albarán de Compra'} {/* Cambiado a Compra */}
        </Typography>
      </Box>
            ...
            >
              <Container maxWidth="lg">
                <Typography variant="h3" gutterBottom sx={{ color: '#1A1A40', fontWeight: '600' }}>
                  Albaranes de Compras {/* Cambiado a Compras */}
                </Typography>
                <Box sx={{ display: 'flex', mb: 3, flexWrap: 'wrap', gap: 1 }}>
                  ...
                  <Button 
                    ...
                    onClick={() => handleOpen()}
                  >
                    Añadir Albarán {/* Cambiado a Albarán de Compras */}
                  </Button>
                  <IconButton
                    sx={{
                      bgcolor: '#FFA500',
...
export default AlbaranesCompras;
