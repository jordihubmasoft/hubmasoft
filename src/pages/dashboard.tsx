...
const Dashboard = () => {
  ...
  const updateChartData = (year, period) => {
    ...
    if (year === '2024' && period === '15 días') {
      updatedData = { /* New dataset for 2024 and last 15 days */ };
      updatedAmount = '€1,200.00';
    } else if (year === '2023' && period === '15 días') {
      updatedData = { /* New dataset for 2023 and last 15 days */ };
      updatedAmount = '€900.00';
    } else {
      updatedData = { /* Default dataset */ };
      updatedAmount = '€0,00';
    }
          ...
          <Container maxWidth="lg">
            ...
            <Box sx={{ display: 'flex', mb: 3, justifyContent: 'flex-start', alignItems: 'center', gap: '10px', maxWidth: '50%' }}>
              ...
              <Zoom in timeout={1500}>
                <IconButton onClick={handleMenuClick} sx={{ bgcolor: '#2666CF', color: '#fff', borderRadius: 2, boxShadow: '0 3px 6px rgba(0,0,0,0.1)' }}>
                ...
                <Grid item xs={12} md={3}>
                  <Zoom in timeout={500}>
                    <Paper sx={{
                      ...
                      <Typography variant="h4" sx={{ color: '#1A1A40', fontWeight: '700', fontFamily: 'Roboto, sans-serif' }}>
                        $1,000
                      </Typography>
                    </Paper>
                  </Zoom>
                  ...
                  >
                    ...
                    >
                      ...
                      <Box sx={{ display: 'flex', gap: 1, alignItems: 'center' }}>
                        <Button 
                          variant="contained" 
                          sx={{ bgcolor: '#2666CF', color: '#fff', textTransform: 'none' }}
                        >
                          Filtrar
                        </Button>
                        <IconButton>
                    ...
                    <Box sx={{ height: 300, position: 'relative' }}>
                      <Chart
                        type='bar'
                        data={{
                          labels: ['1 mar', '14 mar', '27 mar', '9 abr', '22 abr', '5 may', '18 may', '31 may', '13 jun', '26 jun', '9 jul', '22 jul', '4 ago', '17 ago', '31 ago'],
                          datasets: [
                            {
                              type: 'line',
                              label: 'Ingresos',
                              data: [0.1, 0.2, 0.15, 0.3, 0.4, 0.35, 0.45, 0.5, 0.55, 0.6, 0.65, 0.7, 0.75, 0.8, 0.85],
                            ...
                            } as ChartDataset<'line', number[]>,
                            {
                              type: 'bar',
                              label: 'Egresos',
                              data: [0.05, 0.1, 0.08, 0.15, 0.2, 0.18, 0.22, 0.25, 0.28, 0.3, 0.33, 0.35, 0.4, 0.42, 0.45],
                            ...
                            } as ChartDataset<'bar', number[]>,
                            {
                              type: 'line',
                              label: 'Beneficio',
                              data: [0.05, 0.1, 0.07, 0.15, 0.2, 0.17, 0.23, 0.25, 0.27, 0.3, 0.32, 0.35, 0.35, 0.38, 0.4],
                  ...
                  <Grid item xs={12} sm={6} md={3}>
                    <Paper sx={{
                      ...
                      <Box sx={{ mt: 2, width: '100%' }}>
                        <Typography variant="body2" sx={{ color: '#888' }}>Progreso del objetivo</Typography>
                        <Box sx={{ position: 'relative', height: 10, bgcolor: '#E0E0E0', borderRadius: 5, mt: 1 }}>
                          <Box sx={{ width: '50%', height: '100%', bgcolor: '#00A9F4', borderRadius: 5 }}></Box>
                        </Box>
                      </Box>
                    </Paper>
                  </Grid>
                ...
                {widgets.showProductosVendidos && (
                  <Grid item xs={12} sm={6} md={3}>
                    <Paper sx={{
                      ...
                      <Box sx={{ mt: 2, width: '100%' }}>
                        <Typography variant="body2" sx={{ color: '#888' }}>Nivel de ventas</Typography>
                        <Box sx={{ position: 'relative', height: 10, bgcolor: '#E0E0E0', borderRadius: 5, mt: 1 }}>
                          <Box sx={{ width: '20%', height: '100%', bgcolor: '#FFA726', borderRadius: 5 }}></Box>
                        </Box>
                      </Box>
                    </Paper>
                  </Grid>
                ...
                {widgets.showDevolucionesClientes && (
                  <Grid item xs={12} sm={6} md={3}>
                    <Paper sx={{
                      ...
                      <Box sx={{ mt: 2, width: '100%' }}>
                        <Typography variant="body2" sx={{ color: '#888' }}>Tasa de devoluciones</Typography>
                        <Box sx={{ position: 'relative', height: 10, bgcolor: '#E0E0E0', borderRadius: 5, mt: 1 }}>
                          <Box sx={{ width: '10%', height: '100%', bgcolor: '#E53935', borderRadius: 5 }}></Box>
                        </Box>
                      </Box>
                    </Paper>
                  </Grid>
                ...
                {widgets.showClientesConVentas && (
                  <Grid item xs={12} sm={6} md={3}>
                    <Paper sx={{
                      ...
                      <Box sx={{ mt: 2, width: '100%' }}>
                        <Typography variant="body2" sx={{ color: '#888' }}>Crecimiento de clientes</Typography>
                        <Box sx={{ position: 'relative', height: 10, bgcolor: '#E0E0E0', borderRadius: 5, mt: 1 }}>
                          <Box sx={{ width: '30%', height: '100%', bgcolor: '#43A047', borderRadius: 5 }}></Box>
                        </Box>
                      </Box>
                    </Paper>
                  </Grid>
