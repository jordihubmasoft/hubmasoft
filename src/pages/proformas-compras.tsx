...
// Simulación de datos de productos para proformas de compras
const productosProformas = [
  { concepto: 'Material A', descripcion: 'Material para construcción', precio: 2000, impuestos: [{ nombre: 'IVA 21%', valor: 0.21 }] },
  { concepto: 'Equipo B', descripcion: 'Equipo de seguridad', precio: 800, impuestos: [{ nombre: 'IVA 21%', valor: 0.21 }] },
];
...
// Función que sugiere descuentos basados en el subtotal
...
const ProformaPage = ({ proforma, handleBack, handleSave }) => {
  ...
  const [productos, setProductos] = useState<Producto[]>([
    {
      concepto: 'Material A',
      descripcion: 'Material para construcción',
      cantidad: 1,
      unidades: 'unidades',
      precio: 2000,
  ...
  const [totalImpuestos, setTotalImpuestos] = useState(420);
  const [total, setTotal] = useState(2420);
    ...
    <Container maxWidth="xl" sx={{ mt: 4 }}>
      ...
      <Box display="flex" alignItems="center" mb={3}>
        ...
        <Typography variant="h5" component="div" sx={{ flexGrow: 1, fontWeight: 'bold' }}>
          {proforma ? 'Editar Proforma' : 'Nueva Proforma de Compra'} {/* Cambiado a Proforma de Compra */}
        </Typography>
      </Box>
            ...
            >
              <Container maxWidth="lg">
                <Typography variant="h3" gutterBottom sx={{ color: '#1A1A40', fontWeight: '600' }}>
                  Proformas de Compras {/* Cambiado a Compras */}
                </Typography>
                <Box sx={{ display: 'flex', mb: 3, flexWrap: 'wrap', gap: 1 }}>
                  ...
                  <Button
                    ...
                    onClick={() => handleOpen()}
                  >
                    Añadir Proforma {/* Cambiado a Proforma de Compras */}
                  </Button>
                  <IconButton
                    sx={{
                      bgcolor: '#FFA500',
...
export default ProformasCompras;
