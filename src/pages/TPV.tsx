...
import Header from 'componentes/Header'; // Asegúrate de que la ruta del componente sea correcta
import Sidebar from 'componentes/Sidebar'; // Asegúrate de que la ruta del componente sea correcta
